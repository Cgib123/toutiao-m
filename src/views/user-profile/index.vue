<template>
  <div class="user-profile">
    ...
    <input type="file" hidden ref="file"
           @change="onFileChange">
    <!-- 个人信息 -->
    <van-cell class="photo-cell" title="头像" is-link center
    ...
    <van-cell title="性别"
              ...
              is-link @click="isUpdateGenderShow=true" />
    ...
    <van-popup v-model="isUpdateNameShow"
               style="height:100%" position="bottom">
...
export default {
  ...
  methods: {
    ...
    onFileChange () {
      ...
      // file-input 如果选了同一个文件 不会触发 change 事件
      // 解决办法：每次使用完毕，把他的 value 清空
